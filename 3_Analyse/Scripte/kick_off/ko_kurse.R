...
for (x in unique(data.final$kurs)) {

  data.temp <- data.final[data.final$kurs == x,]

  file <- paste0("4_Ergebnisse/Grafiken/kick_off/Kurse/", x, ".pdf")
  ...
  text(5.5, 3, paste0("Kurse: ", n_kurse), cex = 1)
  text(5.5, 2, paste0("Teilnehmende: ", teilnehmende), cex = 1)
  text(5.5, 1, paste0("Durchschnittliche Bewertung: ", schnitt), cex = 1.2)
