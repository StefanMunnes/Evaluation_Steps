...
\begin{questionmult}{kurs}\scoring{v=-1}
	\begin{choices}
		\correctchoice{Berufsbegleitende Studien Physik ISS/Gymnasien/Berufliche Schulen 18/19}\scoring{b=1}
	\end{choices}
\end{questionmult}
...
\subsection*{18. Fragen zu den berufsbegleitenden Studien Physik ISS/Gym. /Berufl. Schulen}
...
\itemsfive{fragen_a}{6cm}{\item Das Gesamtkonzept für die bbSt Physik mit der Aufteilung in die Bereiche Fachphysik, Fachdidaktik und Praktikum ist zielführend.}{1}{2}{3}{4}{-1} \\
\itemsfive{fragen_b}{6cm}{\item Die Inhalte für die bbSt Physik sind aufeinander abgestimmt.}{1}{2}{3}{4}{-1} \\
...
\subsection*{19. Fragen zur Struktur und Ablauf in der Fachdphysik}

\input{../bbst_gs_deutsch/_files/_fachdphysik}
...
\subsection*{21. Fragen zur Struktur und Ablauf des Praktikums}

\input{../bbst_gs_deutsch/_files/_praktikum}
