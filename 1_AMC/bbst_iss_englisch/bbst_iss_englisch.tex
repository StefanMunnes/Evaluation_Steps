...
\begin{questionmult}{kurs}\scoring{v=-1}
	\begin{choices}
		\correctchoice{Berufsbegleitende Studien Englisch ISS/Gymnasien/Berufliche Schulen 17/18}\scoring{b=1}
		\correctchoice{Berufsbegleitende Studien Englisch ISS/Gymnasien/Berufliche Schulen 18/19}\scoring{b=2}
	\end{choices}
\end{questionmult}
...
\subsection*{18. Fragen zu den berufsbegleitenden Studien Englisch ISS/Gym. /Berufl. Schulen}
...
\itemsfive{fragen_a}{6cm}{\item Das Gesamtkonzept für die bbSt Englisch mit der Aufteilung in die Bereiche Fachdidaktik, Linguistik, Kulturwissenschaft, Literaturwissenschaft und Sprache ist zielführend.}{1}{2}{3}{4}{-1} \\
\itemsfive{fragen_b}{6cm}{\item Die Inhalte für die bbSt Englisch sind aufeinander abgestimmt.}{1}{2}{3}{4}{-1} \\
