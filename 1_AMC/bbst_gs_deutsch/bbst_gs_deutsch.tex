...
\begin{document}
\onecopy{191}{ % Anzahl der Bögen festlegen (+ AMC anpassen)

\includegraphics[width=0.25\textwidth]{_pics/steps} \hspace{5cm}
\includegraphics[width=0.4\textwidth]{_pics/beberlin}
...
\\ \\
Markieren Sie die gewünschte Antwort mit einem Kreuz im vorgegebenen Kästchen: \includegraphics[scale=0.3]{_pics/kaestchen_kreuz} \\
Bei einem Fehler füllen Sie das falsch markierte Kästchen bitte vollständig aus: \includegraphics[scale=0.3]{_pics/kaestchen_voll}
\\ \\
