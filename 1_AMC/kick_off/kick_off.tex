...
\begin{enumerate}
	...
	\itemsseven{v2}{\item Die Veranstaltung versetzt mich in die\linebreak Lage, die Inhalte selbständig zu vertiefen.} \\
	\itemsseven{v3}{\item Das fachliche Niveau der Veranstaltung empfand ich als angemessen.} \\
	\itemsseven{v4}{\item Das Erlernte und Erfahrene sind für mich beruflich von Nutzen.} \\
	\itemsseven{v5}{\item Es gab genügend Zeit für den allgemeinen bzw. fachlichen Austausch.} \\
	\itemsseven{v6}{\item Die Lehrveranstaltung begann und endete pünktlich.} \\
	\itemsseven{v7}{\item Die Organisation des Programms QuerBer wurde in der Begrüßungsveranstaltung verständlich dargestellt.} \\
	\itemsseven{v8}{\item Die Informationen waren über den\linebreak Bildungsserver problemlos abrufbar.}
