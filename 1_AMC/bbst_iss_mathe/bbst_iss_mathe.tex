...
\begin{questionmult}{kurs}\scoring{v=-1}
	\begin{choices}
		\correctchoice{Berufsbegleitende Studien Mathematik ISS/Gymnasien/Berufliche Schulen A 17/18}\scoring{b=1}
		\correctchoice{Berufsbegleitende Studien Mathematik ISS/Gymnasien/Berufliche Schulen A 18/19}\scoring{b=2}
		\correctchoice{Berufsbegleitende Studien Mathematik ISS/Gymnasien/Berufliche Schulen B 17/18}\scoring{b=1}
		\correctchoice{Berufsbegleitende Studien Mathematik ISS/Gymnasien/Berufliche Schulen B 18/19}\scoring{b=2}
	\end{choices}
\end{questionmult}
...
\subsection*{18. Fragen zu den berufsbegleitenden Studien Mathematik für ISS/Gym. /Berufl. Schulen}
...
\itemsfive{fragen_a}{6cm}{\item Das Gesamtkonzept für die bbSt Mathematik mit der Aufteilung in die Bereiche Fachvorlesung, Fachdidaktik und Übungen ist zielführend.}{1}{2}{3}{4}{-1} \\
...
\input{../bbst_gs_deutsch/_files/_fachvorlesung}

\pagebreak


\subsection*{20. Fragen zur Struktur und Ablauf in den Übungen}
...
\subsection*{21. Fragen zu Struktur und Ablauf in der Fachdidaktik}
