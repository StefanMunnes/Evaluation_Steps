...
\begin{enumerate}
	...
	\itemsseven{v1}{\item Ich konnte die erlernten Inhalte des KICK OFF anwenden.} \\
	\itemsseven{v2}{\item Die Schulleitung war ausreichend über das Patensystem informiert.} \\
	\itemsseven{v3}{\item Die Schulleitung hat sich Zeit für ein gemeinsames Gespräch mit mir und meinem Paten/meiner Patin genommen.} \\
	\itemsseven{v4}{\item Die Ziele der Patenschaft und wie sie organisiert ist, wurden verständlich vermittelt.} \\
	\itemsseven{v5}{\item Mir war bewusst, welche Rolle mein \newline Pate/meine Patin bei meinem Einstieg \newline hatte.} \\
	\itemsseven{v6}{\item Es gab ausreichend Zeit, mich mit meinem Paten/meiner Patin auszutauschen.} \\
...
\begin{enumerate}\resetenum
	...
	\itemsseven{v9}{\item Insgesamt würde ich zukünftigen Quereinsteigern das Konzept der Patenschaft \newline weiterempfehlen.}
