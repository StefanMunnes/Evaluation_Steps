...
\begin{questionmult}{kurs}\scoring{v=-1}
	\begin{choices}
		...
		\correctchoice{Berufsbegleitende Weiterbildung für die Veranstaltung Erweiterungsstudium Sonderpädagogik in der Fachrichtung Lernen/ Emotional und soziale Entwicklung}\scoring{b=15}
	\end{choices}
\end{questionmult}
...
\vspace{0.5cm}
\begin{questionmult}{v13}\scoring{v=-1}
	\begin{choiceshoriz}
...
\subsection*{14. Alter}
\vspace{0.5cm}
\begin{questionmult}{v14}\scoring{v=-1}
	\begin{choices}
...
\vspace{0.5cm}
\begin{questionmult}{v15}\scoring{v=-1}
	\begin{choices}
...
\vspace{0.5cm}
\begin{questionmult}{v16}\scoring{v=-1}
	\begin{choices}
